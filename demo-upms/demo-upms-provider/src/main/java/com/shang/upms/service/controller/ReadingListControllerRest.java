package com.shang.upms.service.controller;
...
import com.shang.upms.service.AmazonProperties;
import com.shang.upms.service.exceptionhandle.BookNotFoundException;
...
import com.shang.upms.service.exceptionhandle.Error;
...
public class ReadingListControllerRest {
    ...
    @RequestMapping(value = "/{id}", method = RequestMethod.PUT,  headers = {"Host=localhost:8080"})
